...
let frequency = [, 0, 0, 0, 0, 0, 0]; // frequency[0] uninitialized
let totalDice = 0;
let dieImages = new Array(12); // array to store img elements

// get die img elements
function start() {
   let button = document.getElementById("rollButton");
   button.addEventListener("click", rollDice, false);
   let length = dieImages.length; // get array's length once before loop
...
function updateFrequencyTable() {
   let results = "<table><caption>Die Rolling Frequencies</caption>" +
